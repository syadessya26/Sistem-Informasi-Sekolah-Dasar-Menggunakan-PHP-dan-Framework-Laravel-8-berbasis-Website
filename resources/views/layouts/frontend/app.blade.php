...
<head>
    ...
    <!-- Title -->
    <title>SDN 1 Kartoharjo | {{ $title ?? '' }}</title>

    <!-- Favicon -->
    <link rel="icon" href="{{ asset('img/icons') }}/icon1.png">
    ...
    <header class="header-area">
        ...
        <div class="top-header-area d-flex justify-content-between align-items-center">
            ...
            <div class="contact-info">
                <a href="#"><span>Phone:</span> +62 803 1829 1002</a>
                <a href="#"><span>Email:</span> sdnkartoharjo1@gmail.com</a>
            </div>
            <!-- Follow Us -->
            <div class="follow-us">
                <span>DATA REFERENSI KEMENDIKBUD</span>
                <a href="https://referensi.data.kemdikbud.go.id/tabs.php?npsn=20537952"><i class="fa fa-home" aria-hidden="true"></i></a>
            </div>
        </div>
