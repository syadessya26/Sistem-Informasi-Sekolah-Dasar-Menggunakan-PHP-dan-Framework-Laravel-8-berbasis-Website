<div class="clever-main-menu">
    <div class="classy-nav-container breakpoint-off">
        ...
        <nav class="classy-navbar justify-content-between" id="cleverNav">
            ...
            <!-- Logo -->
            <a class="nav-brand" href="/"><img src="{{ asset('img/icons') }}/icon1.png" width="50" alt=""> SDN KARTOHARJO 1 </a>
            ...
            <div class="classy-menu">
                ...
                <div class="classynav">
                    <ul>
                        ...
                        <li><a href="https://akademik.sdnkartoharjo1.site/" class="akademik">Akademik</a></li>
                    </ul>
